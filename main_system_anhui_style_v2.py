...
class MainWindow(QMainWindow):
    ...
    def build_header(self):
        ...
        ribbon_layout.setContentsMargins(18, 10, 18, 10)
    ...
    def build_body(self):
        ...
        body_layout.addWidget(left_card, stretch=7)
        ...
        self.video_label.setMinimumSize(880, 500)
        ...
        right_column.addWidget(control_card)
        ...
        right_column.addWidget(info_card)
        ...
        right_column.addWidget(log_card, stretch=1)
    ...
    def reset_ui_state(self, initial: bool = False):
        ...
        self.status_title.setText("当前状态")
        self.status_value.setText("正常监控" if initial else "系统就绪")
