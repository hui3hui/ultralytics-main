...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        if screen is not None:
            ...
            target_w = max(1280, min(1440, int(geo.width() * 0.92)))
            target_h = max(760, min(840, int(geo.height() * 0.88)))
    ...
    def build_body(self):
        ...
        body_layout.addWidget(left_card, stretch=9)
        ...
        self.video_label.setMinimumSize(760, 380)
        ...
        self.status_board.setFixedHeight(176)
        board_layout = QVBoxLayout(self.status_board)
        board_layout.setContentsMargins(14, 10, 14, 10)
        board_layout.setSpacing(8)

        top_board_layout = QHBoxLayout()
        top_board_layout.setSpacing(8)
        ...
        self.board_status_chip.setMinimumWidth(84)
        ...
        control_card.setMinimumWidth(330)
        control_card.setMinimumHeight(208)
        right_column.addWidget(control_card, 3)
        ...
        self.btn_clear_log.setMinimumHeight(36)
        ...
        info_card.setMinimumHeight(172)
        right_column.addWidget(info_card, 3)
        ...
        right_column.addWidget(log_card, 4)
    ...
    def reset_ui_state(self, initial: bool = False):
        ...
        self.video_label.setText("等待启动摄像头\n点击右侧“启动系统”开始检测" if initial else "监控已停止\n可重新点击“启动系统”恢复检测")
        self.video_label.setAlignment(Qt.AlignCenter)
